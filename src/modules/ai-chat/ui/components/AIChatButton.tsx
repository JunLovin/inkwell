...
import { focusRingEmeraldOffset } from "@/shared/ui";
...
export function AIChatButton() {
  ...
  return (
    <button
      ...
      className={`fixed bottom-6 right-6 z-[150] w-12 h-12 flex items-center justify-center rounded-2xl border transition-colors shadow-lg shadow-black/40 cursor-pointer ${focusRingEmeraldOffset} ${
        isOpen
