...
import { Divider, Input, Loader } from "@/shared/components/ui";
import { NoteCard, type Note } from "@/shared/components/ui/note/NoteCard";
import { NoteDrawer } from "@/shared/components/ui/note";
        ...
        {isEmpty && (
          <div className="flex flex-col items-center justify-center flex-1 gap-5 py-20">
            ...
            <div className="text-center">
              <p className="text-zinc-300 text-base font-light">No favorites yet</p>
